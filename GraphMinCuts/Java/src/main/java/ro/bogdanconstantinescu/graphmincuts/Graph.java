...
public class Graph {
	 ...
	 * @param edges
	 *            The edges, key is the vertex and the value is a simple linked
	 *            list of vertices the vertex has edges with.
	 * @param edgesCount
	 *            Stores for each vertex how many edges has.
	 */
	public Graph(final int n, final int m, final Node[] edges, final int[] edgesCount) {
		this.n = n;
		this.m = m;
		this.edges = edges;
	...
	/**
	 * Retrieve a cloned object.
	 * 
	 * @return The cloned object.
	 */
	@Override
	public Graph clone() {
		final Node[] edges = new Node[this.n];
		for (int i = 0; i < n; i++) {

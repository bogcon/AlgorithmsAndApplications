...
public class GraphMinCuts {
	...
	/**
	 * Main function. Reads graph, repeats randomized contraction algorithm a
	...
	public static void main(String[] args) {
		...
		System.out.println("Elapsed: " + ((double) (end - start) / 100)
				+ " seconds to compute the min cuts count.");
		System.out.println("------- End Graph Min Cuts -------\n");
	}
	 ...
	 * correct value, should be repeated. For n^2 * log n the probability to
	 * fail is < 1 / n
	 *
	 * @param graph
	 *            The graph to calculate min cuts.
	 * @return Min cuts count.
	 */
	public static int randomizedContraction(final Graph graph) {
		final Graph g = graph.clone();

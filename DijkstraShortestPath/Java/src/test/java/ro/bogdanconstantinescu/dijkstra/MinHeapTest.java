...
public class MinHeapTest {
	...
	protected HeapNode[] v = { new HeapNode(0, 0, 6), new HeapNode(1, 0, 11),
			new HeapNode(2, 0, 5), new HeapNode(3, 0, 7), new HeapNode(4, 0, 1),
			new HeapNode(5, 0, 9), new HeapNode(6, 0, 100), new HeapNode(7, 0, 4),
			new HeapNode(8, 0, 80), new HeapNode(9, 0, 45), new HeapNode(10, 0, 93),
			new HeapNode(11, 0, 2), new HeapNode(12, 0, 32), new HeapNode(13, 0, 20),
	...
	public void constructorTest() {
		final MinHeap mheap = new MinHeap(100);
	...
	/**
	 * Test case for {@link MinHeap#insert(HeapNode)}.
	 */
	@Test
	public void insertTest() {
		int i, j;
		final MinHeap heap = new MinHeap(this.v.length);
	...
	/**
	 * Test case for {@link MinHeap#insert(HeapNode)} with random elements.
	 */
	@Test
	public void insertTest2() {
		...
		final MinHeap heap = new MinHeap(heapDimension);
	...
	/**
	 * Test case for {@link MinHeap#extractMin()}.
	 */
	@Test
	...
	/**
	 * Test case for {@link MinHeap#delete(int)}.
	 */
	@Test
	...
	public void allTest() {
		...
		for (i = 0; i < heapDimension; i++) { // do randomly inserts or deletes
												// or extracts min

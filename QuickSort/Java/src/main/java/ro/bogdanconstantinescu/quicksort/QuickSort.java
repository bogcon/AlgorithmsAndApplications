...
public class QuickSort {
	 ...
	 */
	public static void quickSort(final int[] v, final int left, final int right) {
		if (left < right) {
			final int i = partition(v, left, right);
	 ...
	 */
	public static int partition(final int[] v, final int left, final int right) {
